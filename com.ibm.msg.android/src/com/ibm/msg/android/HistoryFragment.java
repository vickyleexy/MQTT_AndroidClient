...
public void onCreate(Bundle savedInstanceState) {
    ...
    Connection connection = Connections.getInstance().getConnection(clientHandle);
  ...
  public void refresh() {
    if (arrayAdapter != null) {
      arrayAdapter.clear();
      arrayAdapter.addAll(Connections.getInstance().getConnection(clientHandle).history());
